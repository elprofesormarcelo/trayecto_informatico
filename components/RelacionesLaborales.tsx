...
const RelacionesLaborales: React.FC = () => {
    ...
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h3 className="text-lg font-bold text-custom-orange uppercase tracking-wider">Módulo 3</h3>
          <h2 className="text-4xl md:text-5xl font-extrabold text-custom-dark leading-tight mt-2">
            Relaciones Laborales
          </h2>
          <p className="text-gray-600 text-lg mt-4 max-w-3xl mx-auto">
            Explora los derechos, obligaciones y el marco legal que rigen las interacciones en el entorno profesional del sector tecnológico.
          </p>
        </div>

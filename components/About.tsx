...
const About: React.FC = () => {
  ...
  const isVisible1 = useIntersectionObserver(sectionRef1, { threshold: 0.2, triggerOnce: true });
  const sectionRef2 = useRef<HTMLDivElement>(null);
  const isVisible2 = useIntersectionObserver(sectionRef2, { threshold: 0.2, triggerOnce: true });
  ...
  return (
    <>
      ...
      <section 
        ref={sectionRef2}
        className={`py-20 md:py-32 bg-[#f69811] transition-all duration-1000 ease-out ${
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="flex justify-center order-first md:order-last">
              <img 
                ...
                className="rounded-full shadow-2xl w-64 h-64 md:w-80 md:h-80 object-cover border-4 border-white"
              />
            </div>
            <div className="text-center md:text-left">
              <h3 className="text-3xl md:text-4xl font-extrabold text-custom-dark leading-tight mb-4">
                Conoce al Docente: <span className="text-white">Marcelo Peralta</span>
              </h3>
              ...
              <ul className="space-y-4 text-left">
                <li className="flex items-start">
                  <SimpleCheckIcon />
                  <span className="flex-1"><strong>Experto en Desarrollo de Sistemas:</strong> Amplia trayectoria en la creación y mantenimiento de soluciones informáticas robustas.</span>
                </li>
                <li className="flex items-start">
                  <SimpleCheckIcon />
                  <span className="flex-1"><strong>Especialista en Gestión de Datos:</strong> Profundo conocimiento en administración, procesamiento y análisis de grandes volúmenes de información.</span>
                </li>
                <li className="flex items-start">
                  <SimpleCheckIcon />
                  <span className="flex-1"><strong>Docente Apasionado:</strong> Comprometido con la enseñanza y el desarrollo de habilidades prácticas en sus alumnos.</span>
                </li>
              </ul>
            </div>
          </div>

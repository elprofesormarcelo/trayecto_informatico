...
const ProcesamientoDatos: React.FC = () => {
    ...
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h3 className="text-lg font-bold text-custom-orange uppercase tracking-wider">Módulo 5</h3>
          <h2 className="text-4xl md:text-5xl font-extrabold text-custom-dark leading-tight mt-2">
            Procesamiento de Datos
          </h2>
          <p className="text-gray-600 text-lg mt-4 max-w-3xl mx-auto">
            Introduce los conceptos fundamentales del manejo de datos, incluyendo la recolección, limpieza, análisis y visualización para la toma de decisiones.
          </p>
        </div>
...
export default ProcesamientoDatos;